...
import (
	...
	"github.com/DoModond/go-ethereum/crypto/signify"
	"github.com/DoModond/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/DoModond/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/DoModond/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func downloadSpecTestFixtures(csdb *build.ChecksumDB, cachedir string) string {
	...
	url := fmt.Sprintf("https://github.com/DoModond/execution-spec-tests/releases/download/v%s/%s%s", executionSpecTestsVersion, base, ext)
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/DoModond/go-ethereum/core/rawdb", "github.com/DoModond/go-ethereum/ethdb/leveldb"},
		{"github.com/DoModond/go-ethereum/core/rawdb", "github.com/DoModond/go-ethereum/ethdb/pebbledb"},
	}
